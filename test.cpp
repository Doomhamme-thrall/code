...
int main()
{
	...
	string image_path = "C:\\Users\\y1783\\Pictures\\1\\*.jpg";//待处理图路径（要改）	
	...
	*/
	...
	//*/
	Mat src, dst;
	src = imread("C:\\Users\\y1783\\Pictures\\1\\2.jpg");  //读取校正前图像（改）
	if (src.empty()) {
		printf("not");
		return -1;
	}
	...
	waitKey(100);
	imwrite("C:/Users/y1783/Pictures/2/002.jpg", dst);  //校正后图像（改）
